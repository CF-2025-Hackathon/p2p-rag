...
class LinkFinderM extends BasicSpider
{
    ...
    protected function initialRequests(): array
    {
        ...
        return [
            new Request(
                'GET',
                $this->context['url'] ?? 'https://masters-elektriciteit.be/',
                [$this, 'parse'],
                ['cookies' => $cookieJar],
            ),
        ];
    ...
    private function isValidLink(array $item): bool
    {
        ...
        if (!str_starts_with($item['link'], '/') && !str_starts_with($item['link'], $this->context['url'] ?? 'https://masters-elektriciteit.be/')) {
            return false;
        }
